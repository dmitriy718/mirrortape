  ...
  return (
    <section className="relative overflow-hidden border-t border-border">
      <div
        ...
        style={{
          background:
            'radial-gradient(50% 60% at 50% 100%, rgba(248,113,113,0.05), transparent 60%), radial-gradient(50% 60% at 50% 100%, rgba(52,211,153,0.06), transparent 70%)',
        }}
        aria-hidden="true"
      />
      <div ref={ref} className="relative mx-auto max-w-[900px] px-6 py-28 text-center">
        <h2 className="font-sans text-4xl font-bold tracking-[-0.02em] text-text-1 max-md:text-3xl">
          {'Set your limits first.'.split(' ').map((w, i) => (
            <span
              key={i}
